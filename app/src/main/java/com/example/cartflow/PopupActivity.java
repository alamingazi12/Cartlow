...
public class PopupActivity extends AppCompatActivity {
    ...
    private void initList() {
        recyclerView_product_container=findViewById(R.id.typesumlistcontainer);
        recyclerView_product_container.setHasFixedSize(true);
        recyclerView_product_container.setLayoutManager(new LinearLayoutManager(PopupActivity.this));

        ItemSellAdapter sel_adapter=new ItemSellAdapter(PopupActivity.this,product_list);
